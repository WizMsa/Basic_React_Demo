...
render(){
    return(
            <div className="card card-danger text-center" style={{ minHeight:'45rem' }}>
                ...
                <NavLink to="../AddSupplier" className=" nav-link text-danger">Add Supplier</NavLink>
                </div>
                <div className="col-sm-6">
                <NavLink to="../RemoveSupplier" className="nav-link text-danger">Remove Supplier</NavLink>
                </div>
                </div>
